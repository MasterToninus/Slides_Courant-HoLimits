...
\note[itemize]{
	...
	\item out of the data $\sigms$ we define a subspace of vector fields. (actually a Lie subalgebra since $\iota_{[x,y]}=\Lie_x \iota_y - \iota_y \Lie_x$).
...
\subsection{Goals}
%-----------------------------------------------------------%
\begin{frame}{Goals: Going higher!}
	\begin{itemize}
