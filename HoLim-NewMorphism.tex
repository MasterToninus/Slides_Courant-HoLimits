...
\begin{frame}{A technical lemma (2)}
	  \begin{defblock}[The \emph{small} dgla]
		...
		Observe that any $\sigma \in \Omega^{r+2}_{\mathrm{cl}}$ is a MC (degree 1) element of $\g_r$.
		\pause
		\smallskip
...
\begin{frame}{THM proof: twisted case (1)}
  ...
  \vfill \pause	
	...
	\only<4->{
	\blfootnote{
		One has to check that $\Phi_\sigma$ preseves the positive part. This is immediate since $(\Phi_\sigma)_2 = \Phi_2$.\\ 
		Moreover, we have 
