...
\begin{minipage}[t]{\textwidth}
	...
	\begin{minipage}[t]{0.6\textwidth}
		...
		\tikz[na] \node[scale=0.5,coordinate,fill=blue!20,draw,circle] (n1) {};		    
		   		 Vector bun. $E^{(r)}=TM\oplus (\wedge^{r}T^\ast M)$;
		\\
	...
	\begin{minipage}[t]{\textwidth}
		...
		\tikz[na]\node [scale=0.5,coordinate,fill=red!20,draw,circle] (n4) {};	    
		    		Courant bracket (twisted by $\sigma\in \Omega^{r+1}_{\text{cl}}$)
					\begin{displaymath}
						\begin{tikzcd}
							\lbrack\cdot,\cdot\rbrack_\sigma~:&[-3em] \Gamma(E^{(r)})\otimes \Gamma(E^{(r)}) \ar[r]& \Gamma(E^{(r)})
							\\[-2em]
							& \binom{x_1}{\alpha_1}\otimes\binom{x_2}{\alpha_2} \ar[r,mapsto]					
							& \binom{[x_1,x_2]}{
